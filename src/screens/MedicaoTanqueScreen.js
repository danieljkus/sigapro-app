...
export default class MedicaoTanqueScreen extends Component {
    ...
    onSubmitCalcular = (event) => {
        const { registro } = this.state;
        if ((registro.estoq_tcm_alt_medida === undefined) || (registro.estoq_tcm_alt_medida === '0') || (registro.estoq_tcm_alt_medida === '')) {
    ...
    onCalcularVolume = () => {
        ...
        axios
            .get('/medicaoTanqueCombustivel/calcularVolume', {
                params: {
                    empresa,
                    estoq_tcm_alt_medida: registro.estoq_tcm_alt_medida
                }
            })
            .then(response => {
                const { data } = response;
                ...
                <Card containerStyle={{ padding: 0 }}>
                    ...
                    >
                        <TextInput
                            ...
                            value={estoq_tcm_alt_medida}
                            keyboardType="decimal-pad" // numeric (inteiro) ou decimal-pad (float)

...
export default class ConsultaItensEstoqueScreen extends Component {
    ...
    getListaSaidas = () => {
        const {
            estoq_mei_filial, dataIni, dataFim, estoq_me_idf, estoq_me_numero,
            pagina, listaRegistrosSaidas, item_select
        } = this.state;
    ...
    getListaCompras = () => {
        const {
            estoq_mei_filial, dataIni, dataFim, estoq_me_idf, estoq_me_numero,
            pagina, listaRegistrosCompras, item_select
        } = this.state;
    ...
    getListaNotas = () => {
        const {
            estoq_mei_filial, dataIni, dataFim, estoq_me_idf, estoq_me_numero,
            pagina, listaRegistrosNotas, item_select
        } = this.state;
    ...
    render() {
        const {
            listaRegistrosFiliais, listaRegistrosFornec, listaRegistrosSaidas,
            ...
            filialSelect, item_select, codItem, qtdeEstoque, custo
        } = this.state;
